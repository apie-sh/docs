...
When you finish this page, you'll know how to model tool calls for monitor mode (inference) and guard mode (explicit metadata).
...
- Moving from **monitor** to **guard** mode
...
<CardGroup cols={2}>
  ...
  <Card title="Enforce guardrails" icon="shield" href="/guardrails/enforce-guardrails">
    Switch to guard mode with explicit metadata.
  </Card>
</CardGroup>
