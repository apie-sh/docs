...
Before enabling guard mode, you want to see which guardrail templates match your agent's risky actions. This recipe runs five scenarios — deploy, vault, database, merge, and shell — in monitor mode.
