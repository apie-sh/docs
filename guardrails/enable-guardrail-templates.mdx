...
Apie ships starter guardrail templates — pre-built policies for common production risks like secret access, production deploys, and destructive shell commands. Enable them with a single CLI command before switching to guard mode.
...
4. Switch to [guard mode](/guardrails/enforce-guardrails)
