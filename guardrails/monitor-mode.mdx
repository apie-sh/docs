...
Monitor mode is the default. Set `releaseMode: "monitor"` explicitly or omit it:
...
console.log(decision.decision); // "block", "allow", etc.
```
...
5. Switch to [guard mode](/guardrails/enforce-guardrails)
